...
<div class="max-w-6xl mx-auto px-4 py-6 text-sm font-extralight text-black">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-6">
        <div>
            ...
            <p class="text-black text-xs mt-1 opacity-80">
                Penginputan Master Data Santri dan Orang Tua. Data otomatis tersimpan di semua fitur data
            </p>
        </div>
    </div>
    {{-- ALERT SUCCESS --}}
    @if(session('success'))
    <div class="mb-5 rounded-xl border border--200 bg-green-50 px-4 py-3 text-green-700 shadow-sm">
        {{ session('success') }}
    </div>
    @endif
    <form action="{{ route('pendaftaran-santri.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-blue-300 overflow-hidden">
                <div class="px-5 py-4 bg-gray-300 border-b border-gray-200">
